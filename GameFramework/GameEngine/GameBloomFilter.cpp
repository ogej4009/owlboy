...
//	BloomCheckPlayer->TEXTURE(L"EmissionTex", HGAMEDEVICE::MAINOBJ()->DataRenderTarget()->Texture(6));
//	BloomCheckPlayer->TEXTURE(L"LightTex", m_Parent->DefferdLightTarget()->Texture(3));
//	BloomCheckPlayer->SAMPLER(L"Smp", L"LCSMP");
//
//	SmallTarget = new HRenderTarget();
//	SmallTarget->CreateTarget(HGAMEWINDOW::MAINOBJ()->Size() * SizeRatio, HVECTOR::NONE);
//
//	SmallTarget2 = new HRenderTarget();
//	SmallTarget2->CreateTarget(HGAMEWINDOW::MAINOBJ()->Size() * SizeRatio, HVECTOR::NONE);
//
//
