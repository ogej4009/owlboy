...
//
//	Data.PixelUv[0].x = 1.0f / HGAMEDEVICE::MAINOBJ()->BackBufferRenderTarget()->Texture(0)->Size().x * _Len;
//	Data.PixelUv[0].y = 0.0f;
//
//	Data.PixelUv[1].x = -(1.0f / HGAMEDEVICE::MAINOBJ()->BackBufferRenderTarget()->Texture(0)->Size().x) * _Len;
//	Data.PixelUv[1].y = 0.0f;
//
//	Data.PixelUv[2].x = 0.0f;
//	Data.PixelUv[2].y = -(1.0f / HGAMEDEVICE::MAINOBJ()->BackBufferRenderTarget()->Texture(0)->Size().y) * _Len;
//
//	Data.PixelUv[3].x = 0.0f;
//	Data.PixelUv[3].y = 1.0f / HGAMEDEVICE::MAINOBJ()->BackBufferRenderTarget()->Texture(0)->Size().y * _Len;
//
...
//	LinePlayer->TEXTURE(L"Tex", HGAMEDEVICE::MAINOBJ()->DataRenderTarget()->Texture(7));
