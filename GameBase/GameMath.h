...
public:
	...
	{
		memcpy_s(this, sizeof(CTransData), &_Other, sizeof(CTransData));
	}
...
public:
	union
	{
		...
		CMatrix ARRMAT[(int)MRX_GRID::MRX_MAX];
	};
...
public:
	...
	CTransDataGrid(const CTransDataGrid& _Other)
	{
		memcpy_s(this, sizeof(CTransDataGrid), &_Other, sizeof(CTransDataGrid));
	}
