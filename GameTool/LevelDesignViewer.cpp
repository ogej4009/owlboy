...
*/

	{
		...
		m_TileMapCom = m_TileMapActor->CreateCom<GameTileMap>(80, 46, L"ColLevel1.png", 0); // 짝수여야 하네
	}
	...
	//{
	//	CPtr<GameActor> NewActor = GetScene()->CreateActor();
	//	CPtr<GameRenderer> NewRender = NewActor->CreateCom<GameRenderer>(L"Grid", L"TileMap"); //  메쉬, 메테리얼
